...
const u32 gTemporalBagScreen_Gfx[] = INCBIN_U32("graphics/bag/temporal/menu.4bpp.smol");
const u32 gTemporalBagScreen_GfxTileMap[] = INCBIN_U32("graphics/bag/temporal/menu.bin.smolTM");
