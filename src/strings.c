...
const u8 gText_DexRegTitle[] = _("REGIONAL DEX");
const u8 gText_DexExtTitle[] = _("EXTENDED DEX");
...
const u8 gText_DexSortBSTTitle[] = _("Base Stat MODE");
...
const u8 gText_DexRegDescription[] = _("HOENN region's POKéDEX");
const u8 gText_DexExtDescription[] = _("HOENN region's Extended POKéDEX");
...
const u8 gText_DexSortBSTDescription[] = _("Owned POKéMON are listed\nby their base stat total.");
...
const u8 gText_Attack4[] = _("ATK");
const u8 gText_Defense3[] = _("DEFENSE");
const u8 gText_Defense4[] = _("DEF");
