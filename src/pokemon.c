...
static const u16 sHoennToNationalOrder[REGIONAL_DEX_COUNT - 1] =
{
    REGIONAL_TO_NATIONAL(TREECKO),
    REGIONAL_TO_NATIONAL(GROVYLE),
    REGIONAL_TO_NATIONAL(SCEPTILE),
    REGIONAL_TO_NATIONAL(TORCHIC),
    REGIONAL_TO_NATIONAL(COMBUSKEN),
    REGIONAL_TO_NATIONAL(BLAZIKEN),
    REGIONAL_TO_NATIONAL(MUDKIP),
    REGIONAL_TO_NATIONAL(MARSHTOMP),
    REGIONAL_TO_NATIONAL(SWAMPERT),
    REGIONAL_TO_NATIONAL(POOCHYENA),
    REGIONAL_TO_NATIONAL(MIGHTYENA),
    REGIONAL_TO_NATIONAL(ZIGZAGOON),
    REGIONAL_TO_NATIONAL(LINOONE),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GALARIAN_FORMS
    REGIONAL_TO_NATIONAL(OBSTAGOON),
#endif
    REGIONAL_TO_NATIONAL(WURMPLE),
    REGIONAL_TO_NATIONAL(SILCOON),
    REGIONAL_TO_NATIONAL(BEAUTIFLY),
    REGIONAL_TO_NATIONAL(CASCOON),
    REGIONAL_TO_NATIONAL(DUSTOX),
    REGIONAL_TO_NATIONAL(LOTAD),
    REGIONAL_TO_NATIONAL(LOMBRE),
    REGIONAL_TO_NATIONAL(LUDICOLO),
    REGIONAL_TO_NATIONAL(SEEDOT),
    REGIONAL_TO_NATIONAL(NUZLEAF),
    REGIONAL_TO_NATIONAL(SHIFTRY),
    REGIONAL_TO_NATIONAL(TAILLOW),
    REGIONAL_TO_NATIONAL(SWELLOW),
    REGIONAL_TO_NATIONAL(WINGULL),
    REGIONAL_TO_NATIONAL(PELIPPER),
    REGIONAL_TO_NATIONAL(RALTS),
    REGIONAL_TO_NATIONAL(KIRLIA),
    REGIONAL_TO_NATIONAL(GARDEVOIR),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    REGIONAL_TO_NATIONAL(GALLADE),
#endif
    REGIONAL_TO_NATIONAL(SURSKIT),
    REGIONAL_TO_NATIONAL(MASQUERAIN),
    REGIONAL_TO_NATIONAL(SHROOMISH),
    REGIONAL_TO_NATIONAL(BRELOOM),
    REGIONAL_TO_NATIONAL(SLAKOTH),
    REGIONAL_TO_NATIONAL(VIGOROTH),
    REGIONAL_TO_NATIONAL(SLAKING),
    REGIONAL_TO_NATIONAL(ABRA),
    REGIONAL_TO_NATIONAL(KADABRA),
    REGIONAL_TO_NATIONAL(ALAKAZAM),
    REGIONAL_TO_NATIONAL(NINCADA),
    REGIONAL_TO_NATIONAL(NINJASK),
    REGIONAL_TO_NATIONAL(SHEDINJA),
    REGIONAL_TO_NATIONAL(WHISMUR),
    REGIONAL_TO_NATIONAL(LOUDRED),
    REGIONAL_TO_NATIONAL(EXPLOUD),
    REGIONAL_TO_NATIONAL(MAKUHITA),
    REGIONAL_TO_NATIONAL(HARIYAMA),
    REGIONAL_TO_NATIONAL(GOLDEEN),
    REGIONAL_TO_NATIONAL(SEAKING),
    REGIONAL_TO_NATIONAL(MAGIKARP),
    REGIONAL_TO_NATIONAL(GYARADOS),
    REGIONAL_TO_NATIONAL(AZURILL),
    REGIONAL_TO_NATIONAL(MARILL),
    REGIONAL_TO_NATIONAL(AZUMARILL),
    REGIONAL_TO_NATIONAL(GEODUDE),
    REGIONAL_TO_NATIONAL(GRAVELER),
    REGIONAL_TO_NATIONAL(GOLEM),
    REGIONAL_TO_NATIONAL(NOSEPASS),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    REGIONAL_TO_NATIONAL(PROBOPASS),
#endif
    REGIONAL_TO_NATIONAL(SKITTY),
    REGIONAL_TO_NATIONAL(DELCATTY),
    REGIONAL_TO_NATIONAL(ZUBAT),
    REGIONAL_TO_NATIONAL(GOLBAT),
    REGIONAL_TO_NATIONAL(CROBAT),
    REGIONAL_TO_NATIONAL(TENTACOOL),
    REGIONAL_TO_NATIONAL(TENTACRUEL),
    REGIONAL_TO_NATIONAL(SABLEYE),
    REGIONAL_TO_NATIONAL(MAWILE),
    REGIONAL_TO_NATIONAL(ARON),
    REGIONAL_TO_NATIONAL(LAIRON),
    REGIONAL_TO_NATIONAL(AGGRON),
    REGIONAL_TO_NATIONAL(MACHOP),
    REGIONAL_TO_NATIONAL(MACHOKE),
    REGIONAL_TO_NATIONAL(MACHAMP),
    REGIONAL_TO_NATIONAL(MEDITITE),
    REGIONAL_TO_NATIONAL(MEDICHAM),
    REGIONAL_TO_NATIONAL(ELECTRIKE),
    REGIONAL_TO_NATIONAL(MANECTRIC),
    REGIONAL_TO_NATIONAL(PLUSLE),
    REGIONAL_TO_NATIONAL(MINUN),
    REGIONAL_TO_NATIONAL(MAGNEMITE),
    REGIONAL_TO_NATIONAL(MAGNETON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    REGIONAL_TO_NATIONAL(MAGNEZONE),
#endif
    REGIONAL_TO_NATIONAL(VOLTORB),
    REGIONAL_TO_NATIONAL(ELECTRODE),
    REGIONAL_TO_NATIONAL(VOLBEAT),
    REGIONAL_TO_NATIONAL(ILLUMISE),
    REGIONAL_TO_NATIONAL(ODDISH),
    REGIONAL_TO_NATIONAL(GLOOM),
    REGIONAL_TO_NATIONAL(VILEPLUME),
    REGIONAL_TO_NATIONAL(BELLOSSOM),
    REGIONAL_TO_NATIONAL(DODUO),
    REGIONAL_TO_NATIONAL(DODRIO),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    REGIONAL_TO_NATIONAL(BUDEW),
    REGIONAL_TO_NATIONAL(ROSELIA),
    REGIONAL_TO_NATIONAL(ROSERADE),
#else
    REGIONAL_TO_NATIONAL(ROSELIA),
#endif
    REGIONAL_TO_NATIONAL(GULPIN),
    REGIONAL_TO_NATIONAL(SWALOT),
    REGIONAL_TO_NATIONAL(CARVANHA),
    REGIONAL_TO_NATIONAL(SHARPEDO),
    REGIONAL_TO_NATIONAL(WAILMER),
    REGIONAL_TO_NATIONAL(WAILORD),
    REGIONAL_TO_NATIONAL(NUMEL),
    REGIONAL_TO_NATIONAL(CAMERUPT),
    REGIONAL_TO_NATIONAL(SLUGMA),
    REGIONAL_TO_NATIONAL(MAGCARGO),
    REGIONAL_TO_NATIONAL(TORKOAL),
    REGIONAL_TO_NATIONAL(GRIMER),
    REGIONAL_TO_NATIONAL(MUK),
    REGIONAL_TO_NATIONAL(KOFFING),
    REGIONAL_TO_NATIONAL(WEEZING),
    REGIONAL_TO_NATIONAL(SPOINK),
    REGIONAL_TO_NATIONAL(GRUMPIG),
    REGIONAL_TO_NATIONAL(SANDSHREW),
    REGIONAL_TO_NATIONAL(SANDSLASH),
    REGIONAL_TO_NATIONAL(SPINDA),
    REGIONAL_TO_NATIONAL(SKARMORY),
    REGIONAL_TO_NATIONAL(TRAPINCH),
    REGIONAL_TO_NATIONAL(VIBRAVA),
    REGIONAL_TO_NATIONAL(FLYGON),
    REGIONAL_TO_NATIONAL(CACNEA),
    REGIONAL_TO_NATIONAL(CACTURNE),
    REGIONAL_TO_NATIONAL(SWABLU),
    REGIONAL_TO_NATIONAL(ALTARIA),
    REGIONAL_TO_NATIONAL(ZANGOOSE),
    REGIONAL_TO_NATIONAL(SEVIPER),
    REGIONAL_TO_NATIONAL(LUNATONE),
    REGIONAL_TO_NATIONAL(SOLROCK),
    REGIONAL_TO_NATIONAL(BARBOACH),
    REGIONAL_TO_NATIONAL(WHISCASH),
    REGIONAL_TO_NATIONAL(CORPHISH),
    REGIONAL_TO_NATIONAL(CRAWDAUNT),
    REGIONAL_TO_NATIONAL(BALTOY),
    REGIONAL_TO_NATIONAL(CLAYDOL),
    REGIONAL_TO_NATIONAL(LILEEP),
    REGIONAL_TO_NATIONAL(CRADILY),
    REGIONAL_TO_NATIONAL(ANORITH),
    REGIONAL_TO_NATIONAL(ARMALDO),
    REGIONAL_TO_NATIONAL(IGGLYBUFF),
    REGIONAL_TO_NATIONAL(JIGGLYPUFF),
    REGIONAL_TO_NATIONAL(WIGGLYTUFF),
    REGIONAL_TO_NATIONAL(FEEBAS),
    REGIONAL_TO_NATIONAL(MILOTIC),
    REGIONAL_TO_NATIONAL(CASTFORM),
    REGIONAL_TO_NATIONAL(STARYU),
    REGIONAL_TO_NATIONAL(STARMIE),
    REGIONAL_TO_NATIONAL(KECLEON),
    REGIONAL_TO_NATIONAL(SHUPPET),
    REGIONAL_TO_NATIONAL(BANETTE),
    REGIONAL_TO_NATIONAL(DUSKULL),
    REGIONAL_TO_NATIONAL(DUSCLOPS),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    REGIONAL_TO_NATIONAL(DUSKNOIR),
    REGIONAL_TO_NATIONAL(TROPIUS),
    REGIONAL_TO_NATIONAL(CHINGLING),
#else
    REGIONAL_TO_NATIONAL(TROPIUS),
#endif
    REGIONAL_TO_NATIONAL(CHIMECHO),
    REGIONAL_TO_NATIONAL(ABSOL),
    REGIONAL_TO_NATIONAL(VULPIX),
    REGIONAL_TO_NATIONAL(NINETALES),
    REGIONAL_TO_NATIONAL(PICHU),
    REGIONAL_TO_NATIONAL(PIKACHU),
    REGIONAL_TO_NATIONAL(RAICHU),
    REGIONAL_TO_NATIONAL(PSYDUCK),
    REGIONAL_TO_NATIONAL(GOLDUCK),
    REGIONAL_TO_NATIONAL(WYNAUT),
    REGIONAL_TO_NATIONAL(WOBBUFFET),
    REGIONAL_TO_NATIONAL(NATU),
    REGIONAL_TO_NATIONAL(XATU),
    REGIONAL_TO_NATIONAL(GIRAFARIG),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_9_CROSS_EVOS
    REGIONAL_TO_NATIONAL(FARIGIRAF),
#endif
    REGIONAL_TO_NATIONAL(PHANPY),
    REGIONAL_TO_NATIONAL(DONPHAN),
    REGIONAL_TO_NATIONAL(PINSIR),
    REGIONAL_TO_NATIONAL(HERACROSS),
    REGIONAL_TO_NATIONAL(RHYHORN),
    REGIONAL_TO_NATIONAL(RHYDON),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    REGIONAL_TO_NATIONAL(RHYPERIOR),
#endif
    REGIONAL_TO_NATIONAL(SNORUNT),
    REGIONAL_TO_NATIONAL(GLALIE),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_4_CROSS_EVOS
    REGIONAL_TO_NATIONAL(FROSLASS),
#endif
    REGIONAL_TO_NATIONAL(SPHEAL),
    REGIONAL_TO_NATIONAL(SEALEO),
    REGIONAL_TO_NATIONAL(WALREIN),
    REGIONAL_TO_NATIONAL(CLAMPERL),
    REGIONAL_TO_NATIONAL(HUNTAIL),
    REGIONAL_TO_NATIONAL(GOREBYSS),
    REGIONAL_TO_NATIONAL(RELICANTH),
    REGIONAL_TO_NATIONAL(CORSOLA),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GALARIAN_FORMS
    REGIONAL_TO_NATIONAL(CURSOLA),
#endif
    REGIONAL_TO_NATIONAL(CHINCHOU),
    REGIONAL_TO_NATIONAL(LANTURN),
    REGIONAL_TO_NATIONAL(LUVDISC),
    REGIONAL_TO_NATIONAL(HORSEA),
    REGIONAL_TO_NATIONAL(SEADRA),
    REGIONAL_TO_NATIONAL(KINGDRA),
    REGIONAL_TO_NATIONAL(BAGON),
    REGIONAL_TO_NATIONAL(SHELGON),
    REGIONAL_TO_NATIONAL(SALAMENCE),
    REGIONAL_TO_NATIONAL(BELDUM),
    REGIONAL_TO_NATIONAL(METANG),
    REGIONAL_TO_NATIONAL(METAGROSS),
    REGIONAL_TO_NATIONAL(REGIROCK),
    REGIONAL_TO_NATIONAL(REGICE),
    REGIONAL_TO_NATIONAL(REGISTEEL),
    REGIONAL_TO_NATIONAL(LATIAS),
    REGIONAL_TO_NATIONAL(LATIOS),
    REGIONAL_TO_NATIONAL(KYOGRE),
    REGIONAL_TO_NATIONAL(GROUDON),
    REGIONAL_TO_NATIONAL(RAYQUAZA),
    REGIONAL_TO_NATIONAL(JIRACHI),
...
u16 NationalToHoennOrder(u16 nationalNum)
{
    ...
    while (hoennNum < (REGIONAL_DEX_COUNT - 1) && sHoennToNationalOrder[hoennNum] != nationalNum)
        hoennNum++;

    if (hoennNum >= REGIONAL_DEX_COUNT - 1)
        return 0;
...
{
    if (!hoennNum || hoennNum >= REGIONAL_DEX_COUNT)
        return 0;
...
{
    if (SpeciesToHoennPokedexNum(species) > REGIONAL_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
