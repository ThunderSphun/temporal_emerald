...
static const enum NationalDexOrder sRegionalToNationalOrder[REGIONAL_DEX_COUNT] =
{
...
static const u16 sExtendedToNationalOrder[EXTENDED_DEX_COUNT] =
{
    ...
    EXTENDED_TO_NATIONAL(SHINX),
    EXTENDED_TO_NATIONAL(LUXIO),
    EXTENDED_TO_NATIONAL(LUXRAY),
    EXTENDED_TO_NATIONAL(BUDEW),
    EXTENDED_TO_NATIONAL(ROSERADE),
    EXTENDED_TO_NATIONAL(CRANIDOS),
    EXTENDED_TO_NATIONAL(RAMPARDOS),
    EXTENDED_TO_NATIONAL(SHIELDON),
    EXTENDED_TO_NATIONAL(BASTIODON),
    EXTENDED_TO_NATIONAL(SHELLOS),
    EXTENDED_TO_NATIONAL(GASTRODON),
    EXTENDED_TO_NATIONAL(AMBIPOM),
    EXTENDED_TO_NATIONAL(DRIFLOON),
    EXTENDED_TO_NATIONAL(DRIFBLIM),
    EXTENDED_TO_NATIONAL(BUNEARY),
    EXTENDED_TO_NATIONAL(LOPUNNY),
    EXTENDED_TO_NATIONAL(MISMAGIUS),
    EXTENDED_TO_NATIONAL(HONCHKROW),
    EXTENDED_TO_NATIONAL(CHINGLING),
    EXTENDED_TO_NATIONAL(BRONZOR),
    EXTENDED_TO_NATIONAL(BRONZONG),
    EXTENDED_TO_NATIONAL(BONSLY),
    EXTENDED_TO_NATIONAL(MIME_JR),
    EXTENDED_TO_NATIONAL(HAPPINY),
    EXTENDED_TO_NATIONAL(CHATOT),
    EXTENDED_TO_NATIONAL(SPIRITOMB),
    EXTENDED_TO_NATIONAL(GIBLE),
    EXTENDED_TO_NATIONAL(GABITE),
    EXTENDED_TO_NATIONAL(GARCHOMP),
    EXTENDED_TO_NATIONAL(MUNCHLAX),
    EXTENDED_TO_NATIONAL(SKORUPI),
    EXTENDED_TO_NATIONAL(DRAPION),
    EXTENDED_TO_NATIONAL(CARNIVINE),
    EXTENDED_TO_NATIONAL(FINNEON),
    EXTENDED_TO_NATIONAL(LUMINEON),
    EXTENDED_TO_NATIONAL(MANTYKE),
    EXTENDED_TO_NATIONAL(SNOVER),
    EXTENDED_TO_NATIONAL(ABOMASNOW),
    EXTENDED_TO_NATIONAL(WEAVILE),
    EXTENDED_TO_NATIONAL(MAGNEZONE),
    EXTENDED_TO_NATIONAL(LICKILICKY),
    EXTENDED_TO_NATIONAL(RHYPERIOR),
    EXTENDED_TO_NATIONAL(TANGROWTH),
    EXTENDED_TO_NATIONAL(ELECTIVIRE),
    EXTENDED_TO_NATIONAL(MAGMORTAR),
    EXTENDED_TO_NATIONAL(TOGEKISS),
    EXTENDED_TO_NATIONAL(YANMEGA),
    EXTENDED_TO_NATIONAL(LEAFEON),
    EXTENDED_TO_NATIONAL(GLACEON),
    EXTENDED_TO_NATIONAL(GLISCOR),
    EXTENDED_TO_NATIONAL(MAMOSWINE),
    EXTENDED_TO_NATIONAL(PORYGON_Z),
    EXTENDED_TO_NATIONAL(GALLADE),
    EXTENDED_TO_NATIONAL(PROBOPASS),
    EXTENDED_TO_NATIONAL(DUSKNOIR),
    EXTENDED_TO_NATIONAL(FROSLASS),
    EXTENDED_TO_NATIONAL(ROTOM),
    EXTENDED_TO_NATIONAL(DIALGA),
    EXTENDED_TO_NATIONAL(PALKIA),
    EXTENDED_TO_NATIONAL(HEATRAN),
    EXTENDED_TO_NATIONAL(REGIGIGAS),
    EXTENDED_TO_NATIONAL(GIRATINA),
    EXTENDED_TO_NATIONAL(PHIONE),
    EXTENDED_TO_NATIONAL(MANAPHY),
    EXTENDED_TO_NATIONAL(ARCEUS),
    EXTENDED_TO_NATIONAL(LILLIPUP),
    EXTENDED_TO_NATIONAL(HERDIER),
    EXTENDED_TO_NATIONAL(STOUTLAND),
    EXTENDED_TO_NATIONAL(PIDOVE),
    EXTENDED_TO_NATIONAL(TRANQUILL),
    EXTENDED_TO_NATIONAL(UNFEZANT),
    EXTENDED_TO_NATIONAL(BLITZLE),
    EXTENDED_TO_NATIONAL(ZEBSTRIKA),
    EXTENDED_TO_NATIONAL(ROGGENROLA),
    EXTENDED_TO_NATIONAL(BOLDORE),
    EXTENDED_TO_NATIONAL(GIGALITH),
    EXTENDED_TO_NATIONAL(TIMBURR),
    EXTENDED_TO_NATIONAL(GURDURR),
    EXTENDED_TO_NATIONAL(CONKELDURR),
    EXTENDED_TO_NATIONAL(TYMPOLE),
    EXTENDED_TO_NATIONAL(PALPITOAD),
    EXTENDED_TO_NATIONAL(SEISMITOAD),
    EXTENDED_TO_NATIONAL(THROH),
    EXTENDED_TO_NATIONAL(SAWK),
    EXTENDED_TO_NATIONAL(SEWADDLE),
    EXTENDED_TO_NATIONAL(SWADLOON),
    EXTENDED_TO_NATIONAL(LEAVANNY),
    EXTENDED_TO_NATIONAL(BASCULIN),
    EXTENDED_TO_NATIONAL(SANDILE),
    EXTENDED_TO_NATIONAL(KROKOROK),
    EXTENDED_TO_NATIONAL(KROOKODILE),
    EXTENDED_TO_NATIONAL(DARUMAKA),
    EXTENDED_TO_NATIONAL(DARMANITAN),
    EXTENDED_TO_NATIONAL(MARACTUS),
    EXTENDED_TO_NATIONAL(DWEBBLE),
    EXTENDED_TO_NATIONAL(CRUSTLE),
    EXTENDED_TO_NATIONAL(SCRAGGY),
    EXTENDED_TO_NATIONAL(SCRAFTY),
    EXTENDED_TO_NATIONAL(TIRTOUGA),
    EXTENDED_TO_NATIONAL(CARRACOSTA),
    EXTENDED_TO_NATIONAL(ARCHEN),
    EXTENDED_TO_NATIONAL(ARCHEOPS),
    EXTENDED_TO_NATIONAL(TRUBBISH),
    EXTENDED_TO_NATIONAL(GARBODOR),
    EXTENDED_TO_NATIONAL(ZORUA),
    EXTENDED_TO_NATIONAL(ZOROARK),
    EXTENDED_TO_NATIONAL(GOTHITA),
    EXTENDED_TO_NATIONAL(GOTHORITA),
    EXTENDED_TO_NATIONAL(GOTHITELLE),
    EXTENDED_TO_NATIONAL(DEERLING),
    EXTENDED_TO_NATIONAL(SAWSBUCK),
    EXTENDED_TO_NATIONAL(FOONGUS),
    EXTENDED_TO_NATIONAL(AMOONGUSS),
    EXTENDED_TO_NATIONAL(FRILLISH),
    EXTENDED_TO_NATIONAL(JELLICENT),
    EXTENDED_TO_NATIONAL(ALOMOMOLA),
    EXTENDED_TO_NATIONAL(JOLTIK),
    EXTENDED_TO_NATIONAL(GALVANTULA),
    EXTENDED_TO_NATIONAL(ELGYEM),
    EXTENDED_TO_NATIONAL(BEHEEYEM),
    EXTENDED_TO_NATIONAL(AXEW),
    EXTENDED_TO_NATIONAL(FRAXURE),
    EXTENDED_TO_NATIONAL(HAXORUS),
    EXTENDED_TO_NATIONAL(CUBCHOO),
    EXTENDED_TO_NATIONAL(BEARTIC),
    EXTENDED_TO_NATIONAL(CRYOGONAL),
    EXTENDED_TO_NATIONAL(DRUDDIGON),
    EXTENDED_TO_NATIONAL(BOUFFALANT),
    EXTENDED_TO_NATIONAL(RUFFLET),
    EXTENDED_TO_NATIONAL(BRAVIARY),
    EXTENDED_TO_NATIONAL(DEINO),
    EXTENDED_TO_NATIONAL(ZWEILOUS),
    EXTENDED_TO_NATIONAL(HYDREIGON),
    EXTENDED_TO_NATIONAL(LARVESTA),
    EXTENDED_TO_NATIONAL(VOLCARONA),
    EXTENDED_TO_NATIONAL(COBALION),
    EXTENDED_TO_NATIONAL(TERRAKION),
    EXTENDED_TO_NATIONAL(VIRIZION),
    EXTENDED_TO_NATIONAL(TORNADUS),
    EXTENDED_TO_NATIONAL(THUNDURUS),
    EXTENDED_TO_NATIONAL(LANDORUS),
    EXTENDED_TO_NATIONAL(KELDEO),
    EXTENDED_TO_NATIONAL(BINACLE),
    EXTENDED_TO_NATIONAL(BARBARACLE),
    EXTENDED_TO_NATIONAL(SKRELP),
    EXTENDED_TO_NATIONAL(DRAGALGE),
    EXTENDED_TO_NATIONAL(CLAUNCHER),
    EXTENDED_TO_NATIONAL(CLAWITZER),
    EXTENDED_TO_NATIONAL(TYRUNT),
    EXTENDED_TO_NATIONAL(TYRANTRUM),
    EXTENDED_TO_NATIONAL(AMAURA),
    EXTENDED_TO_NATIONAL(AURORUS),
    EXTENDED_TO_NATIONAL(SYLVEON),
    EXTENDED_TO_NATIONAL(KLEFKI),
    EXTENDED_TO_NATIONAL(GRUBBIN),
    EXTENDED_TO_NATIONAL(CHARJABUG),
    EXTENDED_TO_NATIONAL(VIKAVOLT),
    EXTENDED_TO_NATIONAL(CRABRAWLER),
    EXTENDED_TO_NATIONAL(CRABOMINABLE),
    EXTENDED_TO_NATIONAL(WISHIWASHI),
    EXTENDED_TO_NATIONAL(SALANDIT),
    EXTENDED_TO_NATIONAL(SALAZZLE),
    EXTENDED_TO_NATIONAL(TYPE_NULL),
    EXTENDED_TO_NATIONAL(SILVALLY),
    EXTENDED_TO_NATIONAL(DHELMISE),
    EXTENDED_TO_NATIONAL(ROLYCOLY),
    EXTENDED_TO_NATIONAL(CARKOL),
    EXTENDED_TO_NATIONAL(COALOSSAL),
    EXTENDED_TO_NATIONAL(SIZZLIPEDE),
    EXTENDED_TO_NATIONAL(CENTISKORCH),
    EXTENDED_TO_NATIONAL(IMPIDIMP),
    EXTENDED_TO_NATIONAL(MORGREM),
    EXTENDED_TO_NATIONAL(GRIMMSNARL),
    EXTENDED_TO_NATIONAL(OBSTAGOON),
    EXTENDED_TO_NATIONAL(PERRSERKER),
    EXTENDED_TO_NATIONAL(CURSOLA),
    EXTENDED_TO_NATIONAL(SIRFETCHD),
    EXTENDED_TO_NATIONAL(MR_RIME),
    EXTENDED_TO_NATIONAL(SNOM),
    EXTENDED_TO_NATIONAL(FROSMOTH),
    EXTENDED_TO_NATIONAL(DRACOZOLT),
    EXTENDED_TO_NATIONAL(ARCTOZOLT),
    EXTENDED_TO_NATIONAL(DRACOVISH),
    EXTENDED_TO_NATIONAL(ARCTOVISH),
    EXTENDED_TO_NATIONAL(REGIELEKI),
    EXTENDED_TO_NATIONAL(REGIDRAGO),
    EXTENDED_TO_NATIONAL(WYRDEER),
    EXTENDED_TO_NATIONAL(KLEAVOR),
    EXTENDED_TO_NATIONAL(URSALUNA),
    EXTENDED_TO_NATIONAL(BASCULEGION),
    EXTENDED_TO_NATIONAL(SNEASLER),
    EXTENDED_TO_NATIONAL(OVERQWIL),
    EXTENDED_TO_NATIONAL(ENAMORUS),
    EXTENDED_TO_NATIONAL(SHROODLE),
    EXTENDED_TO_NATIONAL(GRAFAIAI),
    EXTENDED_TO_NATIONAL(BRAMBLIN),
    EXTENDED_TO_NATIONAL(BRAMBLEGHAST),
    EXTENDED_TO_NATIONAL(TOEDSCOOL),
    EXTENDED_TO_NATIONAL(TOEDSCRUEL),
    EXTENDED_TO_NATIONAL(WIGLETT),
    EXTENDED_TO_NATIONAL(WUGTRIO),
    EXTENDED_TO_NATIONAL(CYCLIZAR),
    EXTENDED_TO_NATIONAL(ANNIHILAPE),
    EXTENDED_TO_NATIONAL(CLODSIRE),
    EXTENDED_TO_NATIONAL(FARIGIRAF),
    EXTENDED_TO_NATIONAL(DUDUNSPARCE),
    EXTENDED_TO_NATIONAL(GREAT_TUSK),
    EXTENDED_TO_NATIONAL(SCREAM_TAIL),
    EXTENDED_TO_NATIONAL(BRUTE_BONNET),
    EXTENDED_TO_NATIONAL(FLUTTER_MANE),
    EXTENDED_TO_NATIONAL(SLITHER_WING),
    EXTENDED_TO_NATIONAL(SANDY_SHOCKS),
    EXTENDED_TO_NATIONAL(IRON_TREADS),
    EXTENDED_TO_NATIONAL(IRON_BUNDLE),
    EXTENDED_TO_NATIONAL(IRON_HANDS),
    EXTENDED_TO_NATIONAL(IRON_JUGULIS),
    EXTENDED_TO_NATIONAL(IRON_MOTH),
    EXTENDED_TO_NATIONAL(IRON_THORNS),
    EXTENDED_TO_NATIONAL(ROARING_MOON),
    EXTENDED_TO_NATIONAL(IRON_VALIANT),
    EXTENDED_TO_NATIONAL(KORAIDON),
    EXTENDED_TO_NATIONAL(MIRAIDON),
    EXTENDED_TO_NATIONAL(WALKING_WAKE),
    EXTENDED_TO_NATIONAL(IRON_LEAVES),
    EXTENDED_TO_NATIONAL(GOUGING_FIRE),
    EXTENDED_TO_NATIONAL(RAGING_BOLT),
    EXTENDED_TO_NATIONAL(IRON_BOULDER),
    EXTENDED_TO_NATIONAL(IRON_CROWN),
};
...
enum ExtendedDexOrder NationalToExtendedOrder(enum NationalDexOrder nationalNum)
{
    ...
    while (extendedNum < (EXTENDED_DEX_COUNT - 1) && sExtendedToNationalOrder[extendedNum] != nationalNum)
        extendedNum++;

    if (extendedNum >= EXTENDED_DEX_COUNT - 1)
        return 0;
...
enum RegionalDexOrder SpeciesToRegionalPokedexNum(u16 species)
{
    if (!species)
        return 0;
    return NationalToRegionalOrder(gSpeciesInfo[species].natDexNum);
}
...
enum ExtendedDexOrder SpeciesToExtendedPokedexNum(u16 species)
{
    if (!species)
        return 0;
    return NationalToExtendedOrder(gSpeciesInfo[species].natDexNum);
}

enum NationalDexOrder RegionalToNationalOrder(enum RegionalDexOrder regionalNum)
{
    if (!regionalNum || regionalNum >= REGIONAL_DEX_COUNT)
        return NATIONAL_DEX_NONE;

    return sRegionalToNationalOrder[regionalNum - 1];
}

enum NationalDexOrder ExtendedToNationalOrder(enum ExtendedDexOrder extendedNum)
{
    if (!extendedNum || extendedNum >= EXTENDED_DEX_COUNT)
        return NATIONAL_DEX_NONE;
...
{
    if (SpeciesToRegionalPokedexNum(species) > REGIONAL_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
...
{
    if (SpeciesToExtendedPokedexNum(species) > REGIONAL_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
