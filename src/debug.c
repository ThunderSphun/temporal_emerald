...
static const struct DebugMenuOption sDebugMenu_Actions_Flags[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_REGDEX]        = { COMPOUND_STRING("Toggle {STR_VAR_1}Regional Dex"),    DebugAction_ToggleFlag, DebugAction_FlagsVars_SwitchRegDex },
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_EXTDEX]        = { COMPOUND_STRING("Toggle {STR_VAR_1}Extended Dex"),    DebugAction_ToggleFlag, DebugAction_FlagsVars_SwitchExtDex },
