...
#define KANTO_DEX_COUNT     (NATIONAL_DEX_MEW + 1)
#define JOHTO_DEX_COUNT     (NATIONAL_DEX_CELEBI + 1)
#define HOENN_DEX_COUNT     (NATIONAL_DEX_DEOXYS + 1)
#define SINNOH_DEX_COUNT    (NATIONAL_DEX_ARCEUS + 1)
#define UNOVA_DEX_COUNT     (NATIONAL_DEX_GENESECT + 1)
#define KALOS_DEX_COUNT     (NATIONAL_DEX_VOLCANION + 1)
#define ALOLA_DEX_COUNT     (NATIONAL_DEX_MELMETAL + 1)
#define GALAR_DEX_COUNT     (NATIONAL_DEX_ENAMORUS + 1)
#define PALDEA_DEX_COUNT    (NATIONAL_DEX_PECHARUNT + 1)

#define REGIONAL_DEX_COUNT  (REGIONAL_DEX_DEOXYS + 1)
#define EXTENDED_DEX_COUNT  (EXTENDED_DEX_IRON_CROWN + 1)
#define NATIONAL_DEX_COUNT  (NATIONAL_DEX_PECHARUNT + 1)
