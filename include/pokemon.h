...
enum RegionalDexOrder NationalToRegionalOrder(enum NationalDexOrder nationalNum);
enum RegionalDexOrder SpeciesToRegionalPokedexNum(u16 species);
enum NationalDexOrder RegionalToNationalOrder(enum RegionalDexOrder regionalNum);
enum NationalDexOrder ExtendedToNationalOrder(enum ExtendedDexOrder extendedNum);
enum ExtendedDexOrder SpeciesToExtendedPokedexNum(u16 species);
enum ExtendedDexOrder NationalToExtendedOrder(enum NationalDexOrder nationalNum);
...
bool32 IsSpeciesInExtendedDex(u16 species);
